...
const featuredDoctors = [
    ...
    { name: "د/ مرقس صفوت", specialty: "استشاري النساء والتوليد", bio: "متابعة الحمل والولادة الآمنة، وعلاج مشاكل العقم وتأخر الإنجاب برعاية فائقة.", schedule: "🕐 يومياً: 6:00 م - 9:00 م", image: "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=400&h=400&fit=crop" },
